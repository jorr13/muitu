...
/*estilos home parte 2*/

    .botonseccion2 {
    font-size: 12px;
    }
    
    .secciondos:after, .secciondos:before, .seccionuno:after, .seccionuno:before {
    margin-top: -30px;
    }
    ...
    .conten:after, .conten:before {
    display: none;
    }

/*estilos home parte tienda*/
...
/*estilos home parte Blog*/
    ...
    .containerpost:nth-of-type(2n+2) .img-container {
    margin-right: 30px;
    right: 0;
    left: auto;
    padding-right: 0;
...
/*estilos Page template*/
    
    .page-template-default .containerposts {
    padding: 5%;
    }
    ...
    .post-template-default .containerposts {
   ...
   .format-standard {
    ...
    .format-standard h1, h2, h3, h4, h5 {
    display: block;
    width: 100%;
    }
...
/*estilos seccion comentarios*/
    ...
    border: 3px solid #7e8e71!important;
    border-radius: 0!important;
    color: #7e8e71!important;
...
/*estilos home parte 2*/
    ...
    .contenedorseccionuno .conten {
    padding-left: 30px;
    }
    
    .contenedorsecciondos .contendos {
    padding-right: 30px;
    }
...
/*estilos home parte 2*/
 ...
 /*estilos home parte 4*/
    ...
    .contenedorsecciondos .column.is-1 {
    display:none;
    }
    
    .contenedorsecciondos .imgseccion {
    width: 85%;
    margin: 0 auto !important;
    height: 45% !important;
