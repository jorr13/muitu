...
Vue.component('posts-loop', __webpack_require__(368));
Vue.component('pages-loop', __webpack_require__(374));
Vue.component('list-product', __webpack_require__(379));
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_pagination_vue__ = __webpack_require__(365);
...
var update = __webpack_require__(137)("63a6d6d4", content, false, {});
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "posts columns" }, [
    _c(
      "div",
      ...
      [
        ...
        _c("br"),
        _vm._v(" "),
        _c("p", { staticClass: "conteposts animated fadeInUp" }, [
          _vm._v(
            "Conoce sobre las comunidades que le han dado vida a cada producto que distribuimos, su cultura, su lenguaje y su amor"
          )
        ]),
        _c("br"),
        _vm._v(" "),
        _vm._l(_vm.posts, function(post, index) {
          return _c(
            "div",
            { key: index, staticClass: "containerpost column is-9" },
            [
              ...
              _c(
                "a",
                { staticClass: "link posts-link", attrs: { href: post.link } },
                [
                  _c("div", { staticClass: "contenido" }, [
                    _c("h4", { staticClass: "titleposts posts-title" }, [
                      _vm._v("\n        " + _vm._s(post.title.rendered))
                    ]),
                    _vm._v(" "),
                    _c("p", {
                      staticClass: "excerpt posts-excerpt",
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(137)("7a518462", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
      ...
      _c(
        ...
        _vm._l(_vm.posts, function(post, index) {
          return _c(
            ...
            {
              key: index,
              staticClass: "column is-3 post-item animated fadeInUp"
            },
            [
...
Component.options.__file = "resources/assets/js/components/list-product.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6fef5f52", Component.options)
  } else {
    hotAPI.reload("data-v-6fef5f52", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_carousel__ = __webpack_require__(138);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        obtenerProducto: function obtenerProducto(id) {
            var _this2 = this;
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "contenedor-product-categoria " }, [
    _c(
      "div",
      { staticClass: "sliderheader" },
      [
        _c(
          "carousel",
          {
          ...
          _vm._l(_vm.lists, function(item, index) {
            return _c(
              "slide",
              { key: index, class: { "is-hidden": index === 0 } },
              [
                _c(
                  "a",
                  {
                    ref: "el",
                    refInFor: true,
                    attrs: { href: "javascript:void(0)", "data-id": item.id },
                    on: {
                      click: function($event) {
                        _vm.obtenerProducto(item.id), _vm.hola()
                      }
                    }
                  },
                  [
    ...
    _c(
      "div",
      { staticClass: "containerposts containerproduct hamacas" },
      [
        _c(
          "carousel",
          {
          ...
          [
            ...
            _vm.prodcts == ""
              ? _c(
                  ...
                  [
                    _vm._v(
                      "No hay productos para mostrar en este momento. Lo sentimos."
                    )
                  ]
                )
              : _vm._e(),
            _vm._v(" "),
            _vm._l(_vm.prodcts, function(producto, index) {
              return _c("slide", { key: index, staticClass: "productitem" }, [
                _c("a", { attrs: { href: producto.permalink } }, [
                  _c("div", { staticClass: "imgprod" }, [
                    _c("img", {
                      attrs: { src: producto.images["0"].src, alt: "" }
                    })
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "contenidoproduct" }, [
                    _c("h1", [_vm._v(_vm._s(producto.name))])
                  ]),
                  _vm._v(" "),
                  _c(
                    "a",
                    {
                      staticClass: "boton-slider-producto",
                      attrs: { href: producto.permalink }
                    },
                    [_vm._v("Ver Producto")]
                  )
                ])
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: " column botoncontainer ir-a-tienda" }, [
      _c(
        "a",
        { staticClass: "botonposts botonfooter", attrs: { href: "/shop" } },
        [_vm._v("Ir a nuestra tienda")]
      )
    ])
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6fef5f52", module.exports)
  }
}
...
jQuery = __webpack_require__(139);
//Global vars
...
$(".contenedor-titulos-tarjeta-nuestros-servicios").click(function (e) {
    e.preventDefault();
    $(this).siblings(".contenedor-select-categori").toggleClass("active");
});
