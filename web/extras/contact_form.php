...
try {
    ...
    $sendmessage = "<div style=\"background-color: #f3f3f3;color:white;min-height:  500px;box-sizing:  border-box; font-size:12px;\"><a style=\"margin: 0 auto;text-align: center;display: block;\" href=\"http://www.muituhandmade.com\"><img style=\"margin: 20px auto;height: auto;width: 170px;position: relative;display: inline-block;\"src=\"http://www.muituhandmade.com/app/uploads/2018/06/Logo-02.png\"></a><div style=\"position: relative;margin: 0 auto;\"><div style=\"background-image: url(http://www.muituhandmade.com/app/uploads/2018/06/fondo-blog-1.jpg);height: 401px;width: 270px;margin-top: -45px;background-repeat: no-repeat;background-size: cover;position: relative;visibility: visible!important;z-index: 7;margin: 0 auto;padding-top: 93px;\"><div style=\"position: relative;left: 50%;top: 50%;z-index: 8;box-shadow: 0 0 50px rgba(0,0,0,.2)!important;background-color: #fff;color: black;transform: translate(-50%,-50%);padding: 13px;margin-left: 11px;width: 218px;background-color: #fff;color: black;text-align: center;\"><div style=\"font-size: 18px;font-weight: bold;\"> Hola ".utf8_decode($name).",</div><br><div>Gracias Por Contactarnos</div><br>". utf8_decode($template) . "<div>Este es un correo de confirmaci&oacute;n, nos contactaremos con usted lo antes posible</div></div></div></div></div>";    //Message lines should not exceed 70 characters (PHP rule), so wrap it.
